...
- 좌측 더블탭 → **10초 되감기**
- 우측 더블탭 → **10초 앞으로**
- 제스처 인식 영역을 뷰 기준으로 구분해 자연스러운 UX 제공
- 반복 탭 시 누적 시킹 처리
...
## 🚀 향후 확장 방향
- 영상 Progress Bar UI 추가
  재생 위치를 직관적으로 확인할 수 있는 커스텀 프로그레스 바 구성
- Progress Bar Drag-to-Seek 기능 지원
  프로그레스 바를 드래그하여 원하는 재생 위치로 즉시 이동할 수 있는 인터랙션 구현
- 핀치 제스처를 이용한 줌 기능
